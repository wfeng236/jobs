...
def ajax_emailyz(request):
    ...
    html_content = '<p>感谢注册<a href="http://172.16.14.42:9090/user/register/emailyz/?username='+username+'&data='+data+'" target=blank>www.niubiyouxiang.com</a>，\欢迎'+username+'来验证你的邮箱，验证结束你就可以登录了！</p>'
